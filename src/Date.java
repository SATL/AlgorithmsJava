...
/**
 * ****************************************************************************
 * Compilation: javac Date.java Execution: java Date Dependencies: StdOut.java
 *
...
public class Date implements Comparable<Date> {
     ...
     * @return <tt>true</tt> if this date is after that date; <tt>false</tt>
     * otherwise
     */
     ...
     *
     * @param that the other date
     * @return <tt>true</tt> if this date is before that date; <tt>false</tt>
     * otherwise
     */
     ...
     * a negative integer if this date is chronologically less than the argument
     * date; and a positive ineger if this date is chronologically after the
     * argument date
     */
    @Override
